...
export function recordLessonComplete(wallet: string, courseTitle: string, lessonTitle?: string): void {
...
export function recordCourseFinalized(wallet: string, courseTitle: string): void {
...
export function getActivityDays(wallet: string, daysBack = 365): Array<{ date: string; intensity: number }> {
