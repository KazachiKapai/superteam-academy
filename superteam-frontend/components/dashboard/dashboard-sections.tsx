...
// ---------------------------------------------------------------------------
// DashboardWelcome — welcome header + stats row + level progress
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// ContinueLearningList — in-progress course cards
// ---------------------------------------------------------------------------

export function ContinueLearningList({ courses }: { courses: Course[] }) {
  const t = useTranslations("dashboard");
...
// ---------------------------------------------------------------------------
// DashboardHeatmap — activity streak heatmap
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// RecommendedCourseCards — unstarted course cards
// ---------------------------------------------------------------------------

export function RecommendedCourseCards({ courses }: { courses: Course[] }) {
  const t = useTranslations("dashboard");
      ...
      {recommendedCourses.length > 0 ? (
        ...
        <div className="rounded-xl border border-border bg-card p-6 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-4">
            Keep going and finish what you started, or check back later for new
            content.
          </p>
          <Link href="/courses">
...
// ---------------------------------------------------------------------------
// DashboardAchievements — badges grid
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// DashboardRecentActivity — recent activity feed
// ---------------------------------------------------------------------------
